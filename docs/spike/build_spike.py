...
def main():
    ...
    globe_config = {
        "backgroundColor": "#000",
        "globe": {
            # dark equirectangular world map w/ country borders; generated by
            # make_basemap.py. Dashboard can swap in its own texture asset/URL.
            "baseTexture": "earth_dark.png",
            "shading": "color",
